...
public class DcaExponentialMovingAverage {
	 ...
	 */
	public DcaExponentialMovingAverage(int window) {
	...
	public DcaStatistics getStatistics() {
		return new DcaStatistics(count, min, max, getMean(), getStandardDeviation());
	}
