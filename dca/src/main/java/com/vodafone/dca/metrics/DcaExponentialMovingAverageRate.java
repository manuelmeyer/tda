package com.vodafone.dca.metrics;
...
public class DcaExponentialMovingAverageRate {

	private final DcaExponentialMovingAverage rates;
	 ...
	 */
	public DcaExponentialMovingAverageRate(double period, double lapsePeriod, int window) {
		rates = new DcaExponentialMovingAverage(window);
	 ...
	 */
	public synchronized void incrementBy(int total) {
	 ...
	 */
	public DcaStatistics getStatistics() {
		return new DcaStatistics(getCount(), min, max, getMean(), getStandardDeviation());
	}
