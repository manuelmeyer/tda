...
public class DataTransporterAccumulatorEventHandler extends AccumulatorEventHandler {
	...
	public DataTransporterAccumulatorEventHandler(String handlerName, VFROInputOutputMetrics inputOutputMetrics, Lifecycle lifeCycle, MessageChannel outputChannel, int batchSize, int batchTimeout, MapFieldReducer reducer, DataInputParser transformer, List<EventFilter> eventFilters, List<EventEnricher> eventEnrichers) {
