...
public class TestCSVToOffsetParser {
	
	private static final Logger LOG = LoggerFactory.getLogger(TestCSVToOffsetParser.class);
	...
	public void canCreateOffsets() {
		...
		List<List<Offset>> offsets = CSVToOffsetParser.parse(simpleBytes);
